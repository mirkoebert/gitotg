...
@Import({DoubleBogeyPlusCountFunction.class, GolfCourseCatalog.class})
class DoubleBogeyPlusCountFunctionTest {
    ...
    void applyAsInt_countsHolesWithStrokesExactlyTwoOverPar() {
        ...
        int result = cut.applyAsInt(round("Fischland", 10, 4, 2, 5, 5, 4, 4, 3, 4));
